            ...
            <div class=" grid grid-cols-1 md:grid-cols-2 gap-6 max-h-[50vh] overflow-y-auto">
                ...
                <div class="container2">
                    ...
                    <div class="form-group mt-5 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:outline-none focus:ring focus:ring-blue-400">
                        ...
                        <select name="household" id="household" class="barangay-select form-control mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:outline-none focus:ring focus:ring-blue-400 dropdown-with-scroll" onchange="toggleHouseholdForm()">
                    ...
                    <div id="new-household-form" style="display:none;" class="md:col-span-2">
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" id="user_id" class="form-control mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:outline-none focus:ring focus:ring-blue-400 dropdown-with-scroll">
                ...
                noResults: function () {
                    return `
                        <div style="text-align: center;">
                            ...
                            <button id="create-new-household" class="btn btn-primary mt-2">
