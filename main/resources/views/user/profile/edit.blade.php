            ...
            <div id="content" class="flex flex-col md:flex-row flex-1">
                <div id="sidebar" class="bg-gray-100 w-full md:w-[250px] mt-5 flex flex-col justify-between">
                    <nav id="main-nav" class="space-y-2 py-2 px-4">
                        <a href="{{ url('/user-dashboard') }}" class="flex rounded-[25px] font-bold text-xl items-center space-x-2 px-4 py-2 {{ Request::is('user-dashboard*') ? 'bg-blue-200 text-blue-900' : 'text-gray-800' }} hover:bg-blue-200 hover:text-blue-900">
